...
```text
set base_path    /media/joan/a/apt-mirror
...
```bash
sudo ln -s /media/joan/a/apt-mirror/mirror/archive.ubuntu.com /var/www/html/archive.ubuntu.com
sudo ln -s /media/joan/a/apt-mirror/mirror/dl.google.com /var/www/html/dl.google.com
ls -la /var/www/html
```
...
```bash
sudo ln -s /media/joan/a/apt-mirror/mirror/nginx.org /var/www/html/nginx.org
ls -la /var/www/html
```
